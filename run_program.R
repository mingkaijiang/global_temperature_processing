...
#### at monthly timestep
meanDF <- create_storage_DF(sourceDir="/Volumes/Elements/era_interim/raw/")
sdDF <- create_storage_DF(sourceDir="/Volumes/Elements/era_interim/raw/")
nDF <- create_storage_DF(sourceDir="/Volumes/Elements/era_interim/raw/")
...
for (j in 1:length(dname.list)) {
    tmp.out <- prepare_monthly_output(sourceDir="/Volumes/Elements/era_interim/raw/",
                                      dname=dname.list[j])
